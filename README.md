...
5. Once a connection is established with a LE peripheral and the Heart Rate Service is found in the LE peripheral, the application automatically receives heart rate notifications from the server every 1 minute.
